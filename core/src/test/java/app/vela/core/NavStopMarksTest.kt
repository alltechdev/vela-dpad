...
class NavStopMarksTest {
    ...
    private val poly = listOf(
        LatLng(38.60, -122.40), LatLng(38.60, -122.30), LatLng(38.60, -122.20),
    )

    @Test fun waypointOnTheLineMarksAtItsAlongRouteDistance() {
        val mid = LatLng(38.60, -122.30) // exactly the middle vertex
    ...
    @Test fun waypointFarFromTheLineIsNull() {
        val farNorth = LatLng(38.90, -122.30) // ~33 km off the line
        assertNull(NavEngine.stopMarks(route(poly), listOf(farNorth))[0])
    }

    @Test fun marksAreOrderedAlongTheRoute() {
        val a = LatLng(38.60, -122.35) // ~1/4 along
        val b = LatLng(38.60, -122.25) // ~3/4 along
    ...
    @Test fun outAndBackRouteKeepsMarksInStopOrder() {
        ...
        val outAndBack = listOf(
            LatLng(38.60, -122.40), LatLng(38.60, -122.20), LatLng(38.60, -122.30),
        )
        val a = LatLng(38.60, -122.20)
        val b = LatLng(38.60, -122.30)
    ...
    @Test fun emptyAndDegenerateInputs() {
        ...
        assertEquals(listOf(null), NavEngine.stopMarks(route(listOf(LatLng(38.6, -122.4))), listOf(LatLng(38.6, -122.4))))
    }
}
