...
data class Calibration(
    ...
    companion object {
        ...
        // reverted 2026-07-07 - the fragment-punctuation + 42nd fixes handle articulation directly.)
        ...
        val DEFAULT_PATHS: Map<String, List<Int>> = mapOf(
            ...
            // photo's FIFE URL still at [6][0]. Verified live (Taco Bell / Starbucks / a nail salon).
