 ...
 * turns a typed address like "1600 Olive Dr" into a coordinate with no network, so you can route to
 ...
 * matched word-by-word. So "Olive Dr", "Olive Drive" and "Olive Drive" all hit the same
...
class OfflineAddressStore @Inject constructor(
     ...
     * name within [REV_STREET_M] ("on Pine Street"), else null. Bounded by a small lat/lng box so it
