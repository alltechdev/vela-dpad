...
Device-verified wifi-off (the test region). A **quiet offline indicator** (reactive `ConnectivityManager` →
...
(the "grey Davis Family YMCA on the map, orange weight 'YMCA' when I tap it" inconsistency —
